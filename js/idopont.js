...
const CheckoutModal = ({ cart, onClose, onBook, isTestView, onRemoveItem }) => {
    ...
    if (results) {
        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-start sm:items-center justify-center sm:p-4 z-50 overflow-y-auto font-[Poppins] animate-fade-in">
                <div className="bg-white rounded-[1.5rem] shadow-2xl w-full max-w-md transform mt-[10vh] sm:my-8 flex flex-col pb-[env(safe-area-inset-bottom)] overscroll-none animate-fade-in-up overflow-hidden" onClick=${e => e.stopPropagation()}>
                    <header className="px-4 py-3 sm:px-5 sm:py-4 border-b flex justify-between items-center bg-gray-200 rounded-t-[1.5rem] shrink-0">
                        <h3 className="text-lg font-bold text-gray-900">Összegzés</h3>
    ...
    return html`
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-start sm:items-center justify-center p-4 z-50 overflow-y-auto font-[Poppins] animate-fade-in">
            <div className="bg-white rounded-[1.5rem] shadow-[0_20px_50px_rgba(8,_112,_184,_0.2)] w-full max-w-md transform mt-[10vh] sm:my-8 flex flex-col overscroll-none animate-fade-in-up overflow-hidden" onClick=${e => e.stopPropagation()}>
                <header className="px-4 py-3 sm:px-5 sm:py-4 border-b border-gray-200 flex justify-between items-center bg-gray-200 rounded-t-[1.5rem] shrink-0">
    ...
    return html`
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4 z-[60] overflow-y-auto font-[Poppins] animate-fade-in">
            <div className="bg-white rounded-[1.5rem] shadow-2xl w-full max-w-2xl transform transition-all my-8 flex flex-col overscroll-none animate-fade-in-up overflow-hidden" onClick=${e => e.stopPropagation()}>
                ...
                <main ref=${contentRef} className="p-6 overflow-y-auto custom-scrollbar flex-1 bg-white max-h-[60vh]">
                    
                    ${activeTab === 'kresz' && html`
                        <div style=${{ animation: 'fadeIn 0.3s ease-out' }} className="space-y-6 text-sm text-gray-700 leading-relaxed animate-fade-in" key="kresz">
                            <div>
                    ...
                    ${activeTab === 'firstaid' && html`
                        <div style=${{ animation: 'fadeIn 0.3s ease-out' }} className="space-y-6 text-sm text-gray-700 leading-relaxed animate-fade-in" key="firstaid">
                    ...
                    ${activeTab === 'medical' && html`
                        <div style=${{ animation: 'fadeIn 0.3s ease-out' }} className="space-y-6 text-sm text-gray-700 leading-relaxed animate-fade-in" key="medical">
